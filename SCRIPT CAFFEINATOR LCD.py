...
V0 = 180 # We choose baseline voltage ourselves
...
while True:
    ...
    if AVG_MEASUREMENT-V0 > 0:
        ...
        print((AVG_BLANK-V0), (AVG_MEASUREMENT-V0))
        ...
        setupLCD()
        displayString(1,0,"CAFFEINE CONCENT")
        displayString(2,0,str(caf_massconcentration) + "mol/L")
        longDelay(1000)
        displayString(1,0,"                 ")
        displayString(2,0,"                 ")
        displayString(1,0,"REGULAR=" + str(caf_REGULAR) + "mg       ")
        displayString(2,0,"LARGE=" + str(caf_LARGE) + "mg         ")
        longDelay(1000)
        displayString(1,0,"                 ")
        displayString(2,0,"                 ")
        displayString(1,0,"ESPRESSO=" + str(caf_ESPRESSO) + "mg      ")
        displayString(2,0,"CAPPUCCINO=" + str(caf_CAPPUCINO) + "mg     ")
        longDelay(4000)
        displayString(1,0,"                 ")
        displayString(2,0,"                 ")
        while(True):
            
            displayString(1,0,"SCAN MOI POUR    ")
            displayString(2,0,"PLUS D'INFOS!    ")
    else:
